...
<img title="a title" alt="Alt text" src="Selenium_Folder.png">
...
When the contain stopped and the screen display "Crawling Successful", the data folder including Soundcloud_User.csv will exist

**2. Pyspark on Docker**

<img title="a title" alt="Alt text" src="Spark_Folder.png">
...
<img title="a title" alt="Alt text" src="DataFile.png">
<p>
...
<img title="a title" alt="Alt text" src="Data in database.png">
